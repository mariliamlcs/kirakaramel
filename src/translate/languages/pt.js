const messages = {
    pt: {
        translations: {
            titles: {
                streamSchedule: "Agenda de lives",
                monday: "Segunda",
                tuesday: "Terça",
                wednesday: "Quarta",
                thursday: "Quinta",
                ...
                streamerName: "Nome:",
                streamerLanguage: "Idioma:",
                streamerDebutDate: "Data de estreia:",
                streamerGender: "Gênero:",
                streamerAge: "Idade:",
                streamerBirthday: "Aniversário:",
                streamerHeight: "Altura:",
            ...
            messages: {
                readMore: 'Saiba mais',
                aboutPamy: 'Pamy é uma coelha idol querendo ser uma grande cantora. Seu sonho é poder espalhar sua voz pelo mundo e deixar todos ao seu redor felizes com sua música. É incrivelmente animada e carismática, tem uma inteligência e gostos um tanto… peculiares.',
                aboutJesse: "Jesse é uma estrela mágica no qual sonho era trazer alegria e conforto as pessoas com sua música e sua voz. Ela criou seu próprio corpo humanoide com a ajuda da magia em seu livro e foi para a terra tentar seguir o caminho que queria traçar!",
                aboutHanako: "Hanako é uma bruxa que acabou absorvendo energia demoníaca acidentalmente, o que causou na mudança de sua aparência (ganho de chifres, presas e uma cauda flamejante). Durante a noite ela precisa repor suas energias mágicas fazendo o que gosta, como: jogar, desenhar, papear com amigos ou descansar! Tem como objetivo zerar quantos jogos conseguir, enquanto diverte as pessoas com seu jeito bobo! Tem um familiar cachorro-demônio chamado Bellargus, que invocou acidentalmente e é o seu maior tesouro",
                aboutGio: "Suzume Gio é um pássaro mágico que come cimento e usa seus poderes para dar vida a outros Vtubers. Ela mora em uma cidade no céu construída com o cimento que ela comeu durante anos e tem como maior objetivo montar seu próprio exército de pombos.",
